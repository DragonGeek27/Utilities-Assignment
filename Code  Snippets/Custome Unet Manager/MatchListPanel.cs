...
public class MatchListPanel : MonoBehaviour {
    ...
    private void Awake () //create match list
    {
    ...
    private void AvailableMatchesList_OnAvailableMatchesChanged(List<MatchInfoSnapshot> matches)//clear matches when gone and add when added to list
    {
        clearExistingButtons();
        CreateNewJoinGameButtons(matches);
    }

    private void CreateNewJoinGameButtons(List<MatchInfoSnapshot> matches)// Instantiate button for new matches
    {
    ...
    private void clearExistingButtons()//clear all join buttons
    {
